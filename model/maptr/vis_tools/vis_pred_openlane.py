...
def parse_args():
    ...
    parser.add_argument('--config',
                        default='/home/qui_wzh/git_code/final_project/config/fusion/openlane_maptr_fusion.py',
                        help='train config file path')
    parser.add_argument('--load-from',
                        default='/home/qui_wzh/git_code/final_project/output/fusion_maptr_v20/epoch_10.pth')
    parser.add_argument('--work-dir',
                        default='./vis_pred_openlane')
