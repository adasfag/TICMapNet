...
def parse_args():
    ...
    parser.add_argument('--config',
                        default='/home/qui_wzh/git_code/MAP_PER/config/maptr/nusc_maptrv0.py',
                        help='train config file path')
    parser.add_argument('--load-from',default='/home/qui_wzh/git_code/MAP_PER/output/sgingle_frame_maptrv0/epoch_1.pth')
