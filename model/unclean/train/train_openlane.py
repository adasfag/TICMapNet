...
def parse_args():
    ...
    parser.add_argument('--config',
                        default='/home/qui_wzh/git_code/MAP_PER/config/maptr/openlane_maptr_v1.py',
                        help='train config file path')
    parser.add_argument('--load-from',
                        default=None)
    parser.add_argument('--work-dir',
                        default='/home/qui_wzh/git_code/MAP_PER/output/v1/openlane_maptrchanged_decoder/',
                        )#v1:openlane 修改的maptr模型
