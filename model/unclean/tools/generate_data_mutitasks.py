...
import sys
sys.path.append("/home/qui_wzh/git_code/MAP_PER/")#便于调试找到路径
...
def nuscenes_data_prep(
    ...
    if load_augmented is None:
        ...
        nuscenes_converter.create_nuscenes_infos(
            out_dir,root_path, info_prefix, version=version, max_sweeps=max_sweeps
        )
...
parser.add_argument(
    "--out-dir",
    type=str,
    default="/home/qui_wzh/git_code/MAP_PER/data/muti_tasks/",
    required=False,
