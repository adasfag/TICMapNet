...
from model.detectors.fusion.mutiframe.fusion_maptr import Fusion_MapTR
from model.decoder.fusion.fusion_xjbev_decoder_savememory import FusionXjBevDecoder
